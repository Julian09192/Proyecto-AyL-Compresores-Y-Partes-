...
function PasoPago({ onPagoFinalizado, setPaso }) {
  return (
    <div className="card border-0 shadow-sm p-4 rounded-4 bg-white animate-fade-in">
      ...
      {/* Réplica de Tarjeta de Crédito Estilizada */}
...
function CheckoutPage({ carrito, setVista, vaciarCarrito }) {
  ...
  const procesarTransaccionFinal = async () => {
    ...
    try {
      ...
      // 2. Preparar payload de los items asociados
  ...
  // PANTALLA EXCELENTE: ÉXITO SEGURO
  if (paso === 4) {
    return (
  ...
  return (
    <div className="bg-light min-vh-100 py-5 font-checkout-global">
      <div className="container" style={{ paddingTop: '50px' }}>
        
        {/* STEPPER / BARRA DE PROGRESO INTEGRADA */}
        ...
        <div className="row g-4 justify-content-center align-items-start">
          ...
          {/* COLUMNA DINÁMICA DEL PASO ACTUAL */}
          ...
          {/* COLUMNA DERECHA: RESUMEN LATERAL FLOTANTE */}
      ...
      {/* ESTILOS INTERNOS DE LA VISTA COMPLETA */}
      <style>{`
