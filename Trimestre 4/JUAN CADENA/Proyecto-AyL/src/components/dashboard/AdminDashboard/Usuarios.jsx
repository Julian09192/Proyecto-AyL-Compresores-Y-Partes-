...
function usuario() {
  ...
  const obtenerusuario = async () => {
    try {
      ...
      console.error("Error al obtener usuario desde Supabase:", error.message);
      Swal.fire("Error", "No se pudieron cargar los usuario de la base de datos", "error");
    }
  };
    ...
    <div className="p-4" style={{ backgroundColor: "#f8f9fa", minHeight: "100vh" }}>
      ...
      <div className="container bg-white shadow-sm rounded-4 p-4">
        <div className="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
          <div>
            <h2 className="fw-bold mb-0">Gestión de usuario</h2>
          ...
          <table className="table table-hover border-top">
            ...
            <tbody className="align-middle">
              {filtrados.length > 0 ? (
                ...
                <tr>
                  <td colSpan="4" className="text-center py-4 text-muted">No se encontraron usuario con esos filtros.</td>
                </tr>
              )}
            </tbody>
          </table>
