...
function ProductoDetalleview({ productoId, setVista, login, agregarAlCarrito }) {
  ...
  if (!producto) {
    return <div className="text-center py-5 fw-bold text-muted">Producto no disponible.</div>;
  }
  ...
  return (
    <>
      <Navbar vistaActual="producto-detalle" setVista={setVista} forceSolid={true} />
