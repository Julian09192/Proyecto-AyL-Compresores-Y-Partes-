...
<<<<<<<< HEAD:Trimestre 3/Version Codigo/Proyecto-AyL/src/components/Home/CTA.jsx
        <h2 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "clamp(2rem, 4vw, 3.2rem)", color: "#ffffff", marginBottom: "0.75rem" }}>
========
        <h2 style={{ fontSize: "clamp(2rem, 4vw, 3.2rem)", color: "#ffffff", marginBottom: "0.75rem" }}>
>>>>>>>> 219e875a55184fd6a10c1eeb9feec53b553ebaa1:Backend/Versiones/Version-3/Proyecto-AyL/src/components/Home/CTA.jsx
